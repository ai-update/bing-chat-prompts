...
**Code Troubleshooter**
    ...
    [topic]: "your_topic", [task]: "Help me troubleshoot a coding problem related to [topic]", [requirements]: "Provide step-by-step guidance on identifying and solving the coding issue, and include relevant code examples."

## 🗣️ Languages

**Language Translator**

    [source_language]: "your_source_language", [target_language]: "your_target_language", [task]: "Translate the following text from [source_language] to [target_language]", [requirements]: "Ensure accurate translation while preserving the original context and tone."
